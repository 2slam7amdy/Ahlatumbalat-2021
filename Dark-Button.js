...
var css = '
.conteneur_minwidth_IE, #wrap {
    background-color: #121212;
    color: grey;
}
.inner, .icon, .module, .content, .post, .row {
...
.inner, .icon, .module, .content, .post, .row:hover {
...
document.addEventListener("DOMContentLoaded", function(event) {
    if (posicionBotonModoNoche == 'flotando' || _userdata["session_logged_in"] == 0) {
